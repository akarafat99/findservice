...
if (isset($_POST['tutor'])) {
    ...
    // header("Location: http://localhost/up16/menu/find_services1.php");
    echo '<script> window.location.href="http://localhost/up16/menu/find_services1.php"; </script>';
}
    ...
    <div class="font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <form action="search_result_1.php" method="POST">
                        <div class="input-group">
                            <label class="label">Search by name</label>
                            <input class="input--style-4" type="text" name="search_text" required>
                        </div>
    ...
    <div class="card-section-1">
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="tutor">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="electrician">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="plumber">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="computer_hardware_mechanic">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="computer_software_developer">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="home_wall_painter">Explore</button>
                </form>
            </div>
        </div>
        ...
        <div class="single-card">
            ...
            <div class="single-card-info">
                <form method="POST">
                    <button type="submit" class="service-explore_btn btn-bg-white-cust1" name="other">Explore</button>
                </form>
            </div>
        </div>
