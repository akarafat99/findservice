    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <div class="card-section-1">
                ...
                <div class="single-card">
                    <img src="image/contact_us_1.jpg" alt="image" class="single-card-image">
                    <div class="single-card-content">
                        <p>Contact us page messages</p>
                    </div>
                    <div class="single-card-info">
                        <form method="POST">
                            <button type="submit" class="service-explore_btn" name="contact_us" value="10">Go</button>
                        </form>
                    </div>
                </div>
            </div>
